...
object Fade {
    ...
    fun inLeft(view: View, animatorSet: AnimatorSet): AnimatorSet {
        ...
        val object1: ObjectAnimator = ObjectAnimator.ofFloat(view, "alpha", 0f, 1f)
        val object2: ObjectAnimator = ObjectAnimator.ofFloat(view, "translationX", width / 20f, 0f)
    ...
    fun inUp(view: View, animatorSet: AnimatorSet): AnimatorSet {
        ...
        val object1: ObjectAnimator = ObjectAnimator.ofFloat(view, "alpha", 0f, 1f)
        val object2: ObjectAnimator = ObjectAnimator.ofFloat(view, "translationY", height / 20f, 0f)
        animatorSet.playTogether(object1, object2)
        return animatorSet
    }
